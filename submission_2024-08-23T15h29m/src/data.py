...
def get_data_loaders(
    ...
    #transforms.RandomHorizontalFlip(0.5),  # Data augmentation step
    #transforms.RandomRotation(15),  # Comment out this to reduce rotation
    #transforms.RandAugment(num_ops=2),  # Reduce the number of operations in RandAugment
    #transforms.RandomAffine(10, translate=(0.05, 0.05)),  # Reduce affine transformation intensity
